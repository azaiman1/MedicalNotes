...
def chat_with_gpt4(transcription: str, system_message="You are a helpful medical assistant notetaker.",
                   examples=EXAMPLES, temperature=0.7) -> str:
    """
