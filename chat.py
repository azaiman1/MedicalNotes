...
def chat_with_gpt4(prompt, system_message=None, examples=None, temperature=0.7):
    ...
    response = client.chat.completions.create(
        model="gpt-4",  # Use the appropriate GPT-4 model identifier
        messages=messages,  # Changed to 'prompt'
...
if __name__ == '__main__':
    audio_file_path = "/Users/aaronzaiman/desktop/Patient 1.m4a"  # Replace with the path to your M4A file
